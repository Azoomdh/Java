...
public class J07045 {
    ...
    public static LoaiPhong readPhong(Scanner sc){
    ...
    static class PhongComparator implements Comparator<LoaiPhong> {

        @Override
        public int compare(LoaiPhong o1, LoaiPhong o2) {
            String ten1 = o1.getTenLoaiPhong();
            String ten2 = o2.getTenLoaiPhong();
            Integer soSanhTen = ten1.compareTo(ten2);
